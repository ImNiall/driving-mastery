 ...
 */
export const upsertQuizProgress = debounce(
  async (
    ...
    try {
      console.log("[Supabase] Upserting quiz progress:", {
        attemptId,
        moduleSlug,
        currentIndex,
        state,
 ...
 */
export const upsertQuizAnswers = debounce(
  async (
    supabase: ReturnType<typeof createClient>,
    attemptId: string,
    answers: UserAnswer[],
    ...
    try {
      console.log("[Supabase] Upserting quiz answers:", {
        attemptId,
      ...
      await supabase.from("quiz_answers").upsert(formattedAnswers, {
 ...
 */
export const upsertQuizQuestions = debounce(
  async (
    supabase: ReturnType<typeof createClient>,
    attemptId: string,
    questions: Question[],
    ...
    try {
      console.log("[Supabase] Upserting quiz questions:", {
        attemptId,
