      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md flex flex-col justify-between">
          <div>
            ...
            <p
              className={`text-5xl font-bold ${overallPercentage >= 86 ? "text-brand-green" : "text-brand-blue"}`}
            >
              {overallPercentage}%
            </p>
          ...
          {weakestCategory && (
            <div className="mt-6">
              ...
              <p className="text-sm text-gray-600 mb-3">
                ...
                <span className="font-bold">{weakestCategory.category}</span>.
              </p>
              <div className="space-y-2">
                <button
                  onClick={() => setupQuiz([weakestCategory.category])}
                ...
                <button
                  onClick={() => viewModule(weakestCategory.category)}
