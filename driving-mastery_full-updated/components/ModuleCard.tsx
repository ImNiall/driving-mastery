...
const ModuleCard: React.FC<ModuleCardProps> = ({ module, onSelect }) => {
  return (
    <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 flex flex-col justify-between">
      <div>
        <span className="text-xs font-semibold bg-brand-blue-light text-brand-blue py-1 px-2 rounded-full">{module.category}</span>
        <h3 className="text-lg font-bold text-gray-800 mt-3">{module.title}</h3>
