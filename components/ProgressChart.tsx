        ...
        {hasAttempts ? (
          <>
            <h4 className="font-semibold text-lg text-gray-600">
              We&apos;re crunching the details
            </h4>
            <p className="max-w-xs">
              Your recent quiz attempts have been recorded. Per-topic breakdowns
          ...
          <>
            ...
            <p className="max-w-xs">
              Complete a quiz, and your progress breakdown by topic will appear
              here.
            </p>
          </>
        )}
